...
function ProductLists() {
  ...
  const [maxPriceDisplay, setMaxPriceDisplay] = useState(0); // Renamed
  const [priceRange, setPriceRange] = useState(0); // Slider value
  ...
  const handlePrice = (e) => {
    ...
    filtered = filtered.filter((item) => item.price <= value);
    setList(filtered);
  };
